...
export default class CustomVideoPlayer extends Component {
  ...
  _onEnd() {
    let state = this.state;
    state.currentTime = 0;
    state.seekerPosition = 0;
    state.seekerFillWidth = 0;
    (state.paused = true), this.setState(state);
  }
   ...
   */
  renderFullscreen() {
    let source = this.props.isFullscreen
          ...
          <View
            style={[
              styles.seekbar.fill,
              {
                ...
                backgroundColor: this.props.seekColor || '#4FA4F4',
              },
            ]}
            pointerEvents={'none'}
          />
    ...
    return (
      <TouchableWithoutFeedback
        ...
        <View style={[styles.player.container, this.styles.containerStyle]}>
          ...
          {this.renderError()}
          {this.renderLoader()}
          {this.renderControls && this.renderTopControls()}
          {this.renderControls && this.renderBottomControls()}
        </View>
      </TouchableWithoutFeedback>
    );
  }
